...
export const HERO = {
  eyebrow: "7 videos. Posted to Facebook. You approved once.",
  headlineLine1: "Your Content Channel,",
  headlineLine2: "On Autopilot.",
  subheadline:
    "Plan a full week of Facebook videos in 10 minutes. ReelForge writes every script, generates every video, and posts them automatically — while you're doing anything else.",
  primaryCta: {
...
export const SHOWCASE = {
  ...
  subheadline:
    "Every video below was generated by ReelForge — scripted by AI, visuals built scene by scene, assembled and posted automatically.",
  videos: [
    {
      style: "Cinematic",
