...
const buttonVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        primary:
          "bg-[var(--accent-primary)] text-white hover:bg-[var(--accent-primary)]/90 active:scale-95 shadow-[0_2px_16px_rgba(245,92,42,0.3)] hover:shadow-[0_4px_28px_rgba(245,92,42,0.5)] transition-shadow",
        secondary:
